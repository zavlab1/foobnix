...
data_files = [
    ...
    ('share/foobnix/images', glob.glob('share/foobnix/images/hicolor/*.*')),
    ('share/foobnix/images', glob.glob('share/foobnix/images/hicolor/scalable/*.*')),
    ('share/foobnix/images', glob.glob('share/foobnix/images/hicolor/scalable/apps/*.*')),
    ('share/foobnix/images', glob.glob('share/foobnix/images/hicolor/scalable/actions/*.*')),
